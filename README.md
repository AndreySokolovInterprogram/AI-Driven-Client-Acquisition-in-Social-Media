### 📝 **AI-Driven-Client-Acquisition-in-Social-Media**
...
│   ├── Get_Data.ipynb
│   └── Selecting_the_Best_Posts.ipynb
├── README.md
└── requirements.txt
```
...
- Generate_Posts.ipynb: A laptop for generating text content of posts using Large Language Models (LLM).

- Selecting_the_Best_Posts.ipynb: A laptop for evaluating and selecting the most effective posts using trained neural networks (CNN, LSTM, GRU).
